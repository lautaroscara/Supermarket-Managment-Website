			            ...
			            echo "<div class='ampliar'>
			                    ...
			                    <div class='texto_amp'>
			                        ...
			                        <div class='texto_er'>
			                            ...
			                            <a href='modificacion.php' title='Volver a modificación'>Cancelar</a>
			                            <a href='modificacion2.php?cod=$codigo&desc=$descrip&precio=$precio&stock=$stock&foto=$foto&marca=$marca&sector=$sector' class='bot_alta'>Cambiar</a>
			                        </div>
			                    </div>
			                  </div>";
			        }
